        ...
        <div class="col-md-6 m-auto py-5">          
            <div class="card shadow-sm border border-2 border-primary">              
                <div class="card-body mb-2">
                    <h4 class="text-center my-4 text-primary"> ~ Transfer funds between your accounts ~ </h4>
                    <form action="{{ route('user.transfer_between_accounts') }}" method="POST" autocomplete="off" class="p-2 mt-4">
                        @csrf
                        <div class="row mb-2">
                        ...
                        <div class="row mb-4">
                            <div class="col-8 m-auto form-floating">
                                ...
                                <label for="to_account" class="text-muted ps-4">Account to transfer To :</label>
